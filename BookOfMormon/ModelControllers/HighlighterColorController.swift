...
class HighlighterColorController {
    ...
    func changeColor(to color: Int) {
        ...
        case 3:
            self.currentColor = #colorLiteral(red: 0.8639537692, green: 0.5783758163, blue: 0.3973864317, alpha: 1)
        case 4:
            self.currentColor = #colorLiteral(red: 0.8071166873, green: 0.973033607, blue: 1, alpha: 1)
        case 5:
            self.currentColor = #colorLiteral(red: 1, green: 0.8610861301, blue: 0.6022059917, alpha: 1)
        case 6:
